...
set C_modelArgList {
	...
	{ layer9_out int 512 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "layer9_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer9_out_din sc_out sc_lv 512 signal 1 } 
	{ layer9_out_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ layer9_out_fifo_cap sc_in sc_lv 9 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer9_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "layer9_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer6_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer6_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer9_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 512 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer6_out_fifo_cap fifo_update 0 9 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 } } }
	layer9_out { ap_fifo {  { layer9_out_din fifo_data_in 1 512 }  { layer9_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer9_out_fifo_cap fifo_update 0 9 }  { layer9_out_full_n fifo_status 0 1 }  { layer9_out_write fifo_port_we 1 1 } } }
}
