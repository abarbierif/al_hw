set moduleName relu_array_ap_fixed_64u_array_ap_fixed_16_6_5_3_0_64u_ReLU_config13_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,64u>,array<ap_fixed<16,6,5,3,0>,64u>,ReLU_config13>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer19_out int 1024 regular {fifo 0 volatile }  }
	{ layer13_out int 1024 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer19_out", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer13_out_din sc_out sc_lv 1024 signal 1 } 
	{ layer13_out_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ layer13_out_fifo_cap sc_in sc_lv 9 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "relu_array_ap_fixed_64u_array_ap_fixed_16_6_5_3_0_64u_ReLU_config13_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer19_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer19_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer13_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	relu_array_ap_fixed_64u_array_ap_fixed_16_6_5_3_0_64u_ReLU_config13_s {
...
set Spec2ImplPortList { 
	layer19_out { ap_fifo {  { layer19_out_dout fifo_data_in 0 1024 }  { layer19_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer19_out_fifo_cap fifo_update 0 9 }  { layer19_out_empty_n fifo_status 0 1 }  { layer19_out_read fifo_port_we 1 1 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_data_in 1 1024 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer13_out_fifo_cap fifo_update 0 9 }  { layer13_out_full_n fifo_status 0 1 }  { layer13_out_write fifo_port_we 1 1 } } }
}
