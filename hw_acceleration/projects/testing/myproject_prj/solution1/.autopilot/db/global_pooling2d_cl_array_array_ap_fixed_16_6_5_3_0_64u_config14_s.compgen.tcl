...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer14_out_din { O 1024 vector } layer14_out_num_data_valid { I 2 vector } layer14_out_fifo_cap { I 2 vector } layer14_out_full_n { I 1 bit } layer14_out_write { O 1 bit } } \
} "
}
