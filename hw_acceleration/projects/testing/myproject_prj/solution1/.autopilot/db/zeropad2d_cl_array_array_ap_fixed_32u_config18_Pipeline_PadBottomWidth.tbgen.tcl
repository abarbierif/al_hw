set moduleName zeropad2d_cl_array_array_ap_fixed_32u_config18_Pipeline_PadBottomWidth
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed,32u>,config18>_Pipeline_PadBottomWidth}
