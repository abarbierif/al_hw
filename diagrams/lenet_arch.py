...
arch = [
    ...
    to_connection("C3","S4"),
    to_ConvRes(name="C5", s_filer=120, n_filer=1, offset="(2,0,0)", to="(S4-east)", width=1, height=1, depth=120, opacity=0.2, caption="C5"),
    #to_Conv(name="C5", s_filer=120, n_filer=1, offset="(2,0,0)", to="(S4-east)", width=1, height=1, depth=120, caption="C5"),
    to_connection("S4","C5"),
    to_ConvRes(name="F6", s_filer=84, n_filer=1, offset="(2,0,0)", to="(C5-east)", width=1, height=1, depth=84, opacity=0.2, caption="F6"),
    #to_Conv(name="F6", s_filer=84, n_filer=1, offset="(2,0,0)", to="(C5-east)", width=1, height=1, depth=84, caption="F6"),
    to_connection("C5","F6"),
    to_SoftMax(name="Salida", s_filer=10, offset="(2,0,0)", to="(F6-east)", width=1, height=1, depth=10, opacity=0.8, caption="Salida"),
