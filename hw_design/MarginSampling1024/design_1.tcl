...
\
  ...
  # Create instance: top10_0, and set properties
  set block_name top10
  set block_cell_name top10_0
  if { [catch {set top10_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins top10_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA] [get_bd_intf_pins top10_0/BRAM_PORTB]
  ...
  [get_bd_pins top10_0/rst_n]
  connect_bd_net -net top10_0_ready  [get_bd_pins top10_0/ready] \
